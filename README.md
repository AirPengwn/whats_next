...
>
> **(0) PRE-SWEEP — broken-link check.** Fetch the live JSONbin record
> (bin id and `X-Access-Key` are defined at the top of `_ml_block.txt`; do not
> copy credentials into this README) and read `record.brokenLinks`
